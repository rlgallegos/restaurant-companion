...
function ManageAllergyrBar({setAvailableAllergies, restID, availableAllergies}) {
    const tailwindCSS = "m-auto md:mr-2 mb-2 md:mb-auto md:ml-4 text-lg flex-grow text-gray-900 "
    ...
    return (
        <div>
            ...
            <div className='border border-blue-900 rounded-md bg-blue-800 bg-opacity-50 w-4/5 md:w-1/3 p-12 mx-auto'>
                <form onSubmit={handleSubmit}>
                    ...
                    <input className="m-auto sm:m-4 my-8 text-m flex-grow text-gray-900 border border-blue-400 bg-blue-900 bg-opacity-50 rounded-md px-4 py-2 hover:bg-blue-400 hover:text-white transition-all duration-200 ease-in-out" type='submit' value="Add Allergy Option" />
                </form>
            </div>
        </div>
